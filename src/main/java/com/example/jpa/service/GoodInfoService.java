...
import com.example.jpa.dao.BasicGoodInfoDao;
import com.example.jpa.entity.GoodInfoEntity;
import com.example.jpa.job.GoodAddTimer;
import com.example.jpa.job.GoodSecKillRemindTimer;
import com.example.jpa.job.GoodStockCheckTimer;
import org.quartz.*;
...
public class GoodInfoService {
     ...
     */
    @Autowired
    private BasicGoodInfoDao basicGoodInfoDao;
